...
class DeportesModel extends Model{
    ...
    public function getdeportes(){
        ...
        try{
            $query = $this->db->connect()->query("SELECT SECCION,TITULO,CATEGORIA,NOTICIA,ARCHIVOIMAGEN,ARCHIVOVIDEO,ARCHIVOAUDIO FROM noticias WHERE SECCION=2 ORDER BY TIMESTAMP_REGISTRO DESC");
