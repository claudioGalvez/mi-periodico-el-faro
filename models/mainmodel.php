...
class MainModel extends Model{
    ...
    public function get(){
        ...
        try{
            $query = $this->db->connect()->query("SELECT SECCION,TITULO,CATEGORIA,NOTICIA,ARCHIVOIMAGEN,ARCHIVOVIDEO,ARCHIVOAUDIO FROM noticias WHERE SECCION=1 ORDER BY TIMESTAMP_REGISTRO DESC");
            ...
            print_r('error en la recuperacion de info');
            return[];
        }
